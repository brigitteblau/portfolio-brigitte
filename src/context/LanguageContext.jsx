...
export function LanguageProvider({ children }) {
  ...
  const translations = {
    es: {
      ...
      aboutText:
        "Me gusta pensar antes de construir: entender el por qué, la historia y lo que se quiere provocar. Estoy creciendo entre proyectos web reales, experimentos de visión por computadora y diseño. (Aca va tu historia: colegio, facultad, cursos y lo que te define.)",
      aboutTraits: ["Reflexiva", "Curiosa", "Autodidacta", "Creativa", "Perseverante"],
      aboutEduTitle: "Educacion",
      aboutEducation: [
        {
          when: "Colegio",
          title: "Completar con tu colegio",
          place: "Ciudad, Pais",
          bullets: ["Algo que te marco", "Orientacion / especialidad"],
        },
        {
          when: "Facultad",
          title: "Completar con lo que vas a estudiar",
          place: "Universidad",
          bullets: ["Fecha de inicio (si queres)", "Por que elegiste esa carrera"],
        },
      ],
      aboutCoursesTitle: "Extras",
      aboutCoursesText: "Cursos, talleres y aprendizajes fuera de horario.",
      aboutCourses: ["Completar: curso 1", "Completar: curso 2", "Completar: curso 3"],
      aboutCta: "Hablemos",
