  ...
  return (
    <>
      <button
        ...
        onClick={openAndSpin}
        className={[
          'w-full group rounded-3xl border border-[color:var(--line)] bg-white/70 backdrop-blur-md',
      ...
      >
        <div className="flex items-center gap-4">
          <div className="relative w-20 h-20 rounded-full border border-[color:var(--line)] bg-white shadow-sm overflow-hidden flex-shrink-0">
            <div
            ...
            />
            <div className="absolute inset-2 rounded-full bg-white/85 border border-[color:var(--line)]" />
            <div className="absolute -top-1 left-1/2 -translate-x-1/2 w-0 h-0 border-l-[7px] border-r-[7px] border-b-[10px] border-l-transparent border-r-transparent border-b-[color:var(--wine)] drop-shadow-sm" />
          </div>

          <div className="min-w-0 text-left">
            <p className="text-[11px] uppercase tracking-[0.18em] text-[color:var(--wine)]/90 font-semibold">
              Ruleta random
            </p>
      ...
      {open && (
        ...
        >
          ...
          <div className="relative mx-auto w-[min(720px,94vw)] max-h-[88vh]">
            <div className="relative rounded-[32px] border border-[color:var(--line)] bg-white shadow-[0_30px_120px_rgba(0,0,0,0.22)] overflow-hidden">
              <div className="absolute -top-24 -right-24 h-64 w-64 rounded-full bg-[color:var(--wine)]/15 blur-3xl pointer-events-none" />
              <div className="absolute -bottom-28 -left-24 h-72 w-72 rounded-full bg-[color:var(--wood)]/18 blur-3xl pointer-events-none" />

              <div className="max-h-[88vh] overflow-y-auto">
                <div className="flex items-center justify-between px-5 py-4 border-b border-[color:var(--line)] bg-white/70 backdrop-blur-md sticky top-0 z-20">
                  <div>
                    <p className="text-[11px] uppercase tracking-[0.18em] text-[color:var(--wine)]/90 font-semibold">
                      Ruleta random
                    </p>
                  ...
                  <button
                    ...
                    className="rounded-full border border-[color:var(--line)] bg-white hover:bg-[color:var(--cream)] transition-colors px-3 py-1.5 text-xs font-semibold text-[color:var(--wine)]"
                  >
                    Cerrar
                  </button>
                </div>
                ...
                <div className="relative px-5 py-6 sm:py-8">
                  <div className="relative mx-auto w-[min(380px,78vw)] sm:w-[min(420px,60vw)] aspect-square">
                    <div className="absolute inset-0 rounded-full border border-[color:var(--line)] bg-white/70 shadow-[0_26px_90px_rgba(155,18,48,0.18)]" />
                    <div className="absolute -top-2 left-1/2 -translate-x-1/2 w-0 h-0 border-l-[12px] border-r-[12px] border-b-[18px] border-l-transparent border-r-transparent border-b-[color:var(--wine)] drop-shadow-md z-20" />

                    <div className="absolute inset-[10%] rounded-full overflow-hidden border border-[color:var(--line)] bg-white">
                      <div
                        className="absolute inset-0"
                        style={{
                          background:
                      ...
                      />
                      <div className="absolute inset-4 rounded-full bg-white/85 border border-[color:var(--line)] shadow-inner" />
                    ...
                    <div className="absolute inset-0 grid place-items-center z-30 pointer-events-none">
                      <div className="rounded-full bg-white/85 border border-[color:var(--line)] px-4 py-2 shadow-sm">
                        <p className="text-[11px] uppercase tracking-[0.18em] text-[color:var(--wine)]/90 font-semibold">
                    ...
                    {(spinning || revealed) && (
                      <div className="absolute inset-x-0 top-3 sm:top-4 mx-auto w-[min(520px,92vw)] z-40 pointer-events-none">
                        <div className="mx-auto rounded-3xl border border-[color:var(--line)] bg-white/88 backdrop-blur-md shadow-[0_16px_60px_rgba(0,0,0,0.14)] overflow-hidden">
                          <div className="flex items-center gap-4 px-4 py-4 sm:px-5">
                            <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-full border border-[color:var(--line)] bg-[color:var(--cream)] overflow-hidden flex-shrink-0 shadow-sm">
                              {!spinning && image?.src ? (
                                <img
                                  src={image.src}
                                  alt={fact}
                                ...
                                <div className="w-full h-full bg-gradient-to-br from-[color:var(--wood)]/30 to-[color:var(--cream)]" />
                              )}
                            </div>
                  ...
                  <div className="mt-6 flex items-center justify-center gap-3">
                    <button
                      ...
                      className={[
                        ...
                        'bg-gradient-to-r from-[color:var(--wine)] to-[color:var(--wood)] text-white',
